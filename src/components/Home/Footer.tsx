...
export default function Footer() {
  const [settings, setSettings] = useState({
    contact_email: "support@falmic.com",
    contact_phone: "+0 (105) 115-2920",
    contact_address: "115 Modern Street, 4th Floor",
    facebook_url: "#",
    instagram_url: "#",
    twitter_url: "#",
    linkedin_url: "#",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              {["Home", "What We Do", "Single News"].map((item) => (
                <Link key={item} href="#" className="text-sm text-black/70 hover:text-black transition-colors duration-200">{item}</Link>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <span className="text-sm text-black/70">{settings.contact_phone}</span>
              <span className="text-sm text-black/70">{settings.contact_address}</span>
              <span className="text-sm text-black/70">{settings.contact_email}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            {/* X */}
            <a href={settings.twitter_url || "#"} aria-label="X"
              className="w-9 h-9 rounded-lg border-2 border-black/30 flex items-center justify-center hover:border-black transition-colors duration-200">
              <X size={16} />
            </a>
          </div>
          ...
          <div className="flex items-center gap-8">
            <Link href="#" className="text-sm text-black/70 hover:text-black transition-colors duration-200">Term Of Condition</Link>
            <Link href="#" className="text-sm text-black/70 hover:text-black transition-colors duration-200">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </footer>
